...
export const COMMON_F_NUMBERS = [
  0.7, 0.95 ,1.0, 1.1, 1.2, 1.4, 1.6, 1.8, 2.0, 2.2, 2.5, 2.8, 3.2, 3.5, 4.0, 4.5, 5.0, 5.6, 
  6.3, 7.1, 8.0, 9.0, 10, 11, 13, 14, 16, 18, 20, 22, 25, 28, 32, 36, 40, 45
];
...
export const COMMON_ISO_VALUES = [
  ...
  32000, 40000, 51200, 64000, 80000, 102400, 128000, 160000, 204800, 250000, 320000, 409600, 819200
];
